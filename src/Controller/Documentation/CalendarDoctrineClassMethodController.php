...
final class CalendarDoctrineClassMethodController extends AbstractController implements ControllerWithDataProviderInterface
{
    ...
    {
        return 'calendarDoctrineClassMethod';
    }
